...
I made up fake but realistic data for a webtoon streaming app with 4 tables:

- **users** — 10,000 users, each with country, platform, plan type, signup date
- **sessions** — 50,000 records of when users opened the app
- **transactions** — 28,000 payment records, success or failed or refunded
- **content_views** — 30,000 records of which episodes users watched

Data goes from October 2024 to January 2025.
...
The first call only has one job — write correct SQL. That's it. No 
distractions.
...
Each question takes about 3 to 4 seconds to answer. That's the two AI calls 
